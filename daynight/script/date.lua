...
function DrawTime()
    if TIME_RUN then
        ...
        if InputDown('c') then
            ...
            UiTranslate(0, 60)
            createSlider('X', SunDir, 1, '.', math.rad(-1), math.rad(1), 300, 10, 24)

            UiTranslate(0, 60)
            createSlider('Y', SunDir, 2, '.', math.rad(-1), math.rad(1), 300, 10, 24)

            UiTranslate(0, 60)
            createSlider('Z', SunDir, 3, '.', math.rad(-1), math.rad(1), 300, 10, 24)
